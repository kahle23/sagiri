...
import kunlun.action.support.ai.AbstractScriptBasedAiInvokeHandler;
...
@Slf4j
@Component
public class DbBasedAiHandler extends AbstractScriptBasedAiInvokeHandler implements AutoActionHandler {
