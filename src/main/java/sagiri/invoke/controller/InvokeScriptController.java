 ...
 * @author Sagiri
 * @since 2024-06-02
 * @folder @基础功能/Invoke工具/脚本调用
 */
@Slf4j
@Controller
public class InvokeScriptController {
     ...
     */
    @ResponseBody
    @PostMapping(UrlMapping.INVOKE_SCRIPT_EXECUTE)
    public Result<Object> execute(@RequestBody Dict data) {
        log.info("Invoke script input: {}", JSON.toJSONString(data));
